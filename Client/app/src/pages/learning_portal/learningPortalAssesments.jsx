...
import { fetchAssessments, submitSolvedAssessment } from "../../api/assessments";
        ...
        <aside className="w-64 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm p-6 shadow-lg min-h-screen border-r border-gray-200 dark:border-gray-700 sticky top-16"> {/* Changed to sticky top-16 for navbar */}
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {["All", "Knowledge", "Behavior", "Attitude", "Web Security"].map((category) => (
                <button
                  key={category}
                ...
                {isLoading ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredAssessments.map((assessment) => {
                      const categoryData = categoryIcons[assessment.category] || { 
                        color: "blue", 
                        icon: "📝",
                        gradient: "from-blue-500 to-indigo-500"
                      };
