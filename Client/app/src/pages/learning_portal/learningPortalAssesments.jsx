...
const assessments = [
  {
    ...
    difficulty: "Easy",
    author: "OmarW",
    description: "Test your foundational knowledge of cybersecurity concepts and terminology.",
    questions: [
      {
  ...
  },
  {
    ...
    difficulty: "Medium",
    author: "Abdalhameed",
    description: "Explore network security concepts and test your knowledge of protocols and security measures.",
    questions: [
      {
  ...
  },
  {
    ...
    description: "Dive into encryption techniques and explore the fundamentals of cryptographic systems.",
    questions: [
      {
